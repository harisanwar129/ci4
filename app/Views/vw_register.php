...
<body class="d-flex flex-column h-100">
    ...
    <main class="flex-shrink-0">
        ...
        <option value="5">Senior Manager</option>
                ...
                <div class="mb-3">
                    <label for="tanggal_pk" class="form-label">tanggal pangkat</label>
                    <input type="date" class="form-control" id="tanggal_pk" name="tanggal_pk">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="tanggal_jb" class="form-label"> tgl_jb</label>
                    <input type="date" class="form-control" id="tgl_jb" name="tanggal_jb">
                </div>
                <div class="mb-3">
                    <label for="upload" class="form-label"> upload Sk</label>
